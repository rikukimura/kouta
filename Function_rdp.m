function [ Vdot ] = Function0723(t,V,Mass,TreadWidth,seg_length,...
...
if t < 9
    ...
    yS = 56;
    elseif(9 < t) && (t < 13.58 )
     xS = V(3) + sqrt(200)/(13.58-9) * (t-9);
     yS = 56   + sqrt(200)/(13.58-9) * (t-9);
    else
     xS = V(3) + 20*cos(deg2rad(10.18099)*(18-t));
     yS = 56   + 20*sin(deg2rad(10.18099)*(18-t));
end
    theta_w = (- omega) * t ;
